...
class BeginnerCog(Cog):
    ...
    def load_cogs(client):
        ...
        BeginnerCog.load_extension(client, "beginner.cogs.bump")
        BeginnerCog.load_extension(client, "beginner.cogs.kudos")
        BeginnerCog.load_extension(client, "beginner.cogs.admin")
